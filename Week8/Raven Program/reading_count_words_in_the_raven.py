...
def count_how_many_words(word_list, counting_string):
    ...
    for current_word in word_list:
        if counting_string in current_word:
            count += 1 
            print(count)
            print(current_word)
...
def main():
    ...
    counting_string = "raven"
    print("Count Before Add ", count)
    count += count_how_many_words(words, counting_string)
    print("Count After Add ", count)

    print("How many Ravens are in Poe's Thing: ", count)
    ...
    print("How many Nevermore are in Poe's Thing: ", count)
